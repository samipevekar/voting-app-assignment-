        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-white backdrop-blur-sm bg-opacity-95 rounded-3xl shadow-2xl border border-white border-opacity-20 p-8 mb-8">
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
              ...
              <div className="flex items-center space-x-4">
                {user?.hasVoted && <p className='bg-green-200 text-green-700 px-3 py-1 font-semibold rounded-full'>Voted</p>}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            {/* Refresh */}
            <div className="bg-white flex justify-center items-center backdrop-blur-sm bg-opacity-95 rounded-2xl shadow-xl border border-white border-opacity-20 p-6">
              <div className="">
                <button
