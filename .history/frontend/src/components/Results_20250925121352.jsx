          ...
          <div className="bg-white backdrop-blur-sm bg-opacity-95 rounded-3xl shadow-2xl border border-white border-opacity-20 p-8 mb-8">
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
              ...
              <div className="flex items-center space-x-4">
                ...
                <button
                  onClick={logout}
                  className="bg-gradient-to-r from-red-500 to-pink-500 text-white px-6 py-3 rounded-2xl font-medium hover:from-red-600 hover:to-pink-600 transform hover:scale-105 transition-all duration-200 shadow-lg hover:shadow-xl focus:outline-none focus:ring-4 focus:ring-red-500/30"
                >
            ...
            <div className="mt-8 text-center">
              <div className="bg-white backdrop-blur-sm bg-opacity-95 rounded-2xl shadow-xl border border-white border-opacity-20 p-6 inline-block">
                ...
                <button
                  ...
                  className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-3 rounded-xl font-semibold hover:from-blue-700 hover:to-purple-700 transform hover:scale-105 transition-all duration-200 shadow-lg hover:shadow-xl focus:outline-none focus:ring-4 focus:ring-blue-500/30"
                >
                  <div className="flex items-center space-x-2">
